module UsersHelper
  ...
  # rubocop: disable Style/RedundantInterpolation, Style/LineEndConcatenation, Layout/LineLength
  def same_user?
  ...
  # rubocop: enable Style/RedundantInterpolation, Style/LineEndConcatenation, Layout/LineLength
